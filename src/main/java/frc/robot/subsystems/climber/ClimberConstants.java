...
public class ClimberConstants {
  ...
  public static final double CAGE_CATCHER_EXTEND_POS_INCHES = 2.0; // FIXME: arbitrary for now
  public static final double MAX_HEIGHT_INCHES = 15.0; // FIXME: arbitrary for now
}
